...
У всех перечислений (однострочных и многострочных) ставим запятую после последнего элемента.
Это касается не только списков, но и списков параметров функций, туплов и всего
остального с запятыми.
